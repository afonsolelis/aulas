...
Educational curriculum repository for the discipline **"Refatoração e Arquitetura de Software (IN02)"** at Inteli (Instituto de Tecnologia e Liderança). Course materials — lectures, self-study guides, sprint deliverable templates and assessment rubrics — no runnable code.

## Structure

- `aulas/` — 32 lecture modules (`aula_01.md` through `aula_32.md`) + a skill definition file
