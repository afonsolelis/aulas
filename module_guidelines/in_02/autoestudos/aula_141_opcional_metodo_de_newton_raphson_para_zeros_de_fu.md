# Autoestudo: Opcional: Método de Newton-Raphson para zeros de funções reais - Videoaula
...
Videoaula "Métodos Numéricos - Aula 08 - Zero de funções reais" preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.
...
- https://www.youtube.com/watch?v=TvQJFWf0Qww
