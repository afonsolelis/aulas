# Autoestudo: Opcional: Integração numérica por Newton-Cotes (Regra de Simpson) - Videoaula
...
Videoaula "Métodos Numéricos - Aula 27 - Integração numérica" preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.
...
- https://www.youtube.com/watch?v=la-F_w5v2t0
