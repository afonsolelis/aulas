# Autoestudo: SWEBOK v4: Capítulo 4 (Test Adequacy & Refactoring)
...
Formalização imperativa sobre instrumentações de engenharia reversa para debelar acúmulo de Débitos Técnicos garantindo refatoramento apoiado em blindagens (Testes automatizados contínuos com Spies e cobertura rigorosa TypeScript).

**Eixo disciplinar:** Computação
**Assuntos:** Abordagens de testes de software
...
- https://github.com/joaopauloaramuni/projeto-de-software/blob/main/SWEBOK/swebok-v4.pdf
