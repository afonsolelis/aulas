# Autoestudo: Opcional: Lógica proposicional - videoaula
...
Videoaula "Fundamentos Matemáticos da Computação - Aula 02 - Lógica proposicional", preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.

**Eixo disciplinar:** Matemática e Física
**Assuntos:** Lógica e cálculo proposicional
