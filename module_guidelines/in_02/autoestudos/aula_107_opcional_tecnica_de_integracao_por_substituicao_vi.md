# Autoestudo: Opcional: Técnica de integração por substituição - Videoaula
...
Videoaula "Cálculo I - Aula 21 - Técnicas de integração - parte 1" preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.
...
- https://www.youtube.com/watch?v=gwd8FmP2gOc
