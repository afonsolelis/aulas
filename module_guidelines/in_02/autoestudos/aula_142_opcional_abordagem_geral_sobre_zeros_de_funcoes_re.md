# Autoestudo: Opcional: Abordagem geral sobre zeros de funções reais - Videoaula
...
Videoaula "Métodos Numéricos - Aula 05 - Zeros de funções reais" preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.
...
- https://www.youtube.com/watch?v=8al9UeWF8j4
