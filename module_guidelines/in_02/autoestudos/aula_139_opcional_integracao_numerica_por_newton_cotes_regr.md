# Autoestudo: Opcional: Integração numérica por Newton-Cotes (Regra dos Trapézios) - Videoaula
...
Videoaula "Métodos Numéricos - Aula 26 - Integração numéric" preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.
...
- https://www.youtube.com/watch?v=oCoRt4p717M
