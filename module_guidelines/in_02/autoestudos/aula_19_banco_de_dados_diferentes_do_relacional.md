# Autoestudo: Banco de dados diferentes do relacional
...
Este material traz uma introdução a outros tipos de banco de dados que não o relacional, para visão geral da existência desses outros tipos.

**Eixo disciplinar:** Computação
**Assuntos:** Banco de dados de grafos
...
- https://www.youtube.com/watch?v=890222oPMmM
