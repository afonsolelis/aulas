# Autoestudo: Como sair do zero em Node.js em apenas uma aula
...
O que você precisa saber para criar a sua primeira aplicação em Node.js? Este vídeo te mostra todos os passos para sair do zero e começar a dominar essa ferramenta que é super demandada no mercado de programação.
