# Autoestudo: Boas práticas para escrever um HTML profissional
...
Neste vídeo você vai aprender como escrever melhor HTML, como funciona um HTML mais semântico, como criar páginas com melhores resultados nas páginas de busca do Google (SEO) e com melhor acessibilidade para os usuários.
...
- https://youtu.be/TBplwrsUj4s?feature=shared
