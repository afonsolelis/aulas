# Autoestudo: Testes de Usabilidade
...
O artigo para este autoestudo foi elaborado empregando a metodologia 5W2H, que se baseia na realização de questionamentos para obter informações relevantes para o planejamento de um determinado tema.
