# Autoestudo: SWEBOK v4: Capítulo 2 (Data Design)
...
Subseção imperativa demonstrando a abstração formal da representação de um modelo conceitual transitando para a materialidade da modelagem em bancos RDBMS através da restrição algébrica.
