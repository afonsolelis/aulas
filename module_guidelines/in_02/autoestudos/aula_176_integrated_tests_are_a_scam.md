# Autoestudo: Integrated Tests Are A Scam
...
Exposição acadêmica profunda e provocadora delineando o problema exponencial das regressões não cobertas (explosão combinatória sintática), advogando pela abolição probatória de amontoados integrados em favor de Spies pontuais via Isolamento Estrito sistêmico por camada comportamental.
