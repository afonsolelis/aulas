# Autoestudo: Organizando resultados de testes
...
Você pode estar se perguntando: depois dos testes de usabilidade, como organizar os dados coletados? Neste material, a designer Elisa Volpato ensina algumas técnicas de tabulação de dados coletados, organizando testadores e etapas de utilização no cumprimento de tarefas. Isso nos traz uma visão melhor sobre como priorizar os problemas e como tratá-los.

**Eixo disciplinar:** User Experience
**Assuntos:** Requisitos funcionais e não funcionais
