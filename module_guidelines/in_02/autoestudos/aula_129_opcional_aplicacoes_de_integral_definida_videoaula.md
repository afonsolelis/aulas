# Autoestudo: Opcional: Aplicações de integral definida - Videoaula
...
Videoaula "Cálculo I - Aula 20 - Aplicações" preparada pela Universidade Virtual do Estado de São Paulo (UNIVESP). Assista ao vídeo se achar necessário e desejar complementar o seu aprendizado.
...
- https://www.youtube.com/watch?v=xfVyZXD_hyg
