# Autoestudo: Ferramenta para responsividade e padrões de CSS: Bootstrap
...
Bootstrap é um framework com várias coisas prontas para aplicarmos sobre um conjunto de páginas HTML. Chamamos atenção especial para as facilidades que o framework traz para questões de CSS e responsividade. O uso do framework é opcional. Para mais informações sobre o Bootstrap, acesse aqui: https://getbootstrap.com/docs/5.0/getting-started/introduction/
