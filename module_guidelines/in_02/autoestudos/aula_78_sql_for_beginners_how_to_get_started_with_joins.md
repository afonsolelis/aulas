# Autoestudo: SQL for beginners: how to get started with JOINS
...
Este vídeo traz uma explicação detalhada de como usar "joins" em SQL, que é um conceito fundamental para realizar essas operações no DBeaver com o PostgreSQL.
