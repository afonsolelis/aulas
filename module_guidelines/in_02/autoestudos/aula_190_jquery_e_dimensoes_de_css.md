# Autoestudo: JQuery e dimensões de CSS
...
Ao trabalharmos com JQuery, temos acessos facilitados a elementos HTML, e da mesma forma poderemos alterar classes e propriedades CSS utilizando seus recursos. Este conteúdo fala especificamente sobre técnicas para manipulação de dimensões de objetos HTML.
