# Aula 21 - ZEROS DE FUNÇÕES E INTEGRAÇÃO NUMÉRICA

## Descrição da Aula
O encontro irá abordar métodos para a determinação dos zeros de funções, como o método da bisseção e de Newton-Raphson, além de apresentar técnicas de integração numérica, como os métodos dos trapézios e de Simpson. Serão exploradas suas aplicações na resolução de problemas para os quais não existe solução analítica simples. A relação com o ambiente web será destacada em exemplos.
