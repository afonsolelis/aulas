# Aula 23 - DESENVOLVIMENTO DE NOVOS PRODUTOS - BUSINESS MODEL CANVAS

## Descrição da Aula
Os alunos aprenderão sobre o Business Model Canvas, uma ferramenta útil para visualizar e validar ideias de negócios. Eles aprenderão a usar o Business Model Canvas para desenhar modelos de negócios inovadores.

---
**Visão RM-ODP:** Engineering + Technology
**Eixo:** Negócios
**Assuntos:** Design thinking
,Planos de negócios
