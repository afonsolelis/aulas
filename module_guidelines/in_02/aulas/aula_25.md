# Aula 25 - USABILIDADE, AVALIAÇÃO HEURÍSTICA E ACESSIBILIDADE.

## Descrição da Aula
O encontro de hoje apresenta os seguintes conceitos: 1) A Usabilidade é fundamental para garantir que os usuários possam utilizar o produto digital de forma eficiente e eficaz, aumentando a satisfação e a fidelidade do usuário. 2) Avaliação Heurística que é uma técnica importante para identificar problemas de usabilidade em produtos digitais. 3) A Acessibilidade é essencial para permitir que pessoas com deficiência possam utilizar o produto digital.

---
**Visão RM-ODP:** Engineering + Technology
**Eixo:** User Experience
**Assuntos:** Usabilidade
,User Experience
**Sprint:** 4
