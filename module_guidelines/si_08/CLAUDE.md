...
Educational curriculum repository for the discipline **"Integração, Gerenciamento e Análise de Big Data (SI08)"** at Inteli (Instituto de Tecnologia e Liderança). Course materials — lectures, self-study guides, sprint deliverable templates and assessment rubrics — no runnable code.

## Structure

- `aulas/` — 31 lecture modules (`aula_01.md` through `aula_31.md`) + a skill definition file
