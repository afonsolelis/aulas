# Aula 7 - DO RELATIONSHIPS AND HIERARCHIES IMPACT DECISION-MAKING?

## Descrição da Aula
How do power structures influence the dynamics and effectiveness of a group?
In what ways can a leader value or adapt the existing hierarchy to promote collective success?
What are the challenges and best practices in considering multidimensional impacts when making strategic decisions?
In this session, we will explore the complexities of power structures within groups, both at explicit and implicit levels. We will discuss the importance of strategic decision-making while considering its multidimensional impacts, and examine case studies on different hierarchical constructions and their…

---
**Visão RM-ODP:** Computational
**Eixo:** Liderança
**Assuntos:** Mudança social
