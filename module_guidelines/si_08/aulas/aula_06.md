# Aula 6 - ETL: OBJECT STORAGE TO DATA WAREHOUSE

## Descrição da Aula
By the end of this lesson, students will understand the ETL (Extract, Transform, Load) process within the context of Big Data, including how to extract raw data from an Object Storage system—commonly used as a Data Lake—and how to apply basic data transformations. They will also learn how to load processed data into a Data Warehouse such as ClickHouse or Amazon Redshift and recognize the critical role this process plays in preparing data for the working (Silver) layer of a modern data architecture. The lesson begins with an introduction to ETL in Big Data environments, covering its…

---
**Visão RM-ODP:** Computational
**Eixo:** Computação
**Assuntos:** Métricas de software
,Datalake
