# Autoestudo: Creating Your Own Python Package (YouTube)
...
Step-by-step video tutorial covering Python package structure, init.py, pyproject.toml/setup.py, building wheels, local testing, and publishing to PyPI.
...
- https://www.youtube.com/watch?v=jjzOXp_8TgA
