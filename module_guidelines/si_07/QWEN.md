# QWEN.md — Contexto do Projeto SI07

## Visão Geral do Projeto

Este repositório contém o material didático completo para a disciplina **Sistemas de Informação (SI07)**, com foco na aplicação do framework **RM-ODP** (Reference Model of Open Distributed Processing) e gestão de **Requisitos Não Funcionais (RNF)** baseada nos 8 eixos da norma **ISO/IEC 25010** (SWEBOK).
