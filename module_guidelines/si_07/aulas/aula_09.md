# Aula 9 - CONTABILIDADE DE CUSTOS

## Descrição da Aula
O objetivo desta aula é fornecer uma compreensão clara de contabilidade de custos, uma ferramenta importante para a gestão de custos e a tomada de decisões gerenciais, permitindo às empresas controlar seus gastos e maximizar seus lucros.
