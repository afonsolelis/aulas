# Aula 8 - APRENDIZAGEM COLABORATIVA

## Descrição da Aula
Neste encontro discutiremos estratégias de aprendizagem em uma cultura de projeto colaborativo. Além disso, vamos conhecer mais sobre os Objetivos de Desenvolvimento Sustentável (ODS) e como eles são relevantes no desenvolvimento de projetos.
