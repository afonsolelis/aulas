# Autoestudo: Implementing an SAP Solution
...
Deploy the Technical Solution - Semana 3 (vídeos e leituras recomendadas). Faça este curso ao longo da primeira sprint para entender o passo a passo de uma implementação SAP.
...
- https://pt.coursera.org/learn/implementing-an-sap-solution
