# Autoestudo: Ciência de Processos + Ciência de Dados = Mineração de Processos
...
CIÊNCIA DE PROCESSOS + CIÊNCIA DE DADOS = MINERAÇÃO DE PROCESSOS - Aula da Professora Sarajane Marques Peres (USP) no contexto de disciplina de Gestão de Processos de Negócios
...
- https://www.youtube.com/watch?v=IauzJNVLEQ0
