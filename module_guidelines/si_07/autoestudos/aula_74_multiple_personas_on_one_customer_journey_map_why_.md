# Autoestudo: Multiple Personas on One Customer Journey Map: Why, When, and How
...
O UXPressia reconhece e identifica a necessidade do mapeamento de jornadas com múltiplos usuários, tanto que desenvolveu uma ferramenta paga para fazer isso. Você ponde conhecer a proposta do UXPressia por meio do texto indicado.

**Eixo disciplinar:** User Experience
**Assuntos:** User research
,User Experience
...
- https://uxpressia.com/blog/multiple-personas-on-one-customer-journey-map
