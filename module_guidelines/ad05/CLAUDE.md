...
Educational curriculum repository for the discipline **"Modelagem Financeira e Valuation (AD05)"** at Inteli (Instituto de Tecnologia e Liderança). Course materials — lectures, self-study guides, sprint deliverable templates and assessment rubrics — no runnable code.
