# Autoestudo: O que é um infográfico?
...
Este material é um minicurso da Universidade de Hull (Reino Unido) sobre Infografia. Neste primeiro pequeno capítulo, você deve compreender o conceito de infográfico, suas aplicações e diferenças em relação a outros tipos de documentação.
...
- https://libguides.hull.ac.uk/infographics/Introduction
