# Autoestudo: Estratégias de Storytelling Visual
...
Este material discute o conceito de storytelling visual de forma mais ampla, e oferece algumas estratégias de narrativas que podem ser úteis ao seu projeto ("rags to riches", "common enemy", "aha", "never giving up" etc.).
...
- https://blog.thenounproject.com/business-communication-guide-to-visual-storytelling/
