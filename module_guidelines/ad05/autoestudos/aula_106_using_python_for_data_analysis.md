# Autoestudo: Using Python for Data Analysis
...
Tutorial completo mostrando workflow de análise de dados: leitura, limpeza, organização, visualização, comunicação dos resultados. Pode ser usado como base para gerar relatório final automatizado.
Ian Eyre. Using Python for Data Analysis. Real Python. Acesso em set. 2025.
