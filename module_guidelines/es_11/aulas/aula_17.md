# Aula 17 - TESTES ESTATÍSTICOS PARA VALIDAÇÃO DE HIPÓTESES E COMPARAÇÃO DE INDICADORES

## Descrição da Aula
O encontro tem como objetivo apresentar a inferência estatística como recurso para avaliar hipóteses, comparar grupos e sustentar decisões com base em evidências quantitativas. A aula aborda hipótese nula e hipótese alternativa, nível de significância, valor-p, erros de decisão, comparação entre médias ou proporções, testes para dados categóricos, teste qui-quadrado e noções de normalidade quando houver variáveis numéricas. Espera-se que os estudantes sejam capazes de formular hipóteses estatísticas, escolher testes compatíveis com o tipo de variável analisada, interpretar resultados de forma…
