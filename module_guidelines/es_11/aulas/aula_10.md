# Aula 10 - PROBABILIDADE CONDICIONAL E TEOREMA DE BAYES APLICADOS À ANÁLISE DE BASES RELACIONAIS

## Descrição da Aula
O encontro tem como objetivo aprofundar o uso da probabilidade como ferramenta para analisar relações entre eventos, variáveis e registros em bases estruturadas. A aula aborda probabilidade conjunta, marginal e condicional, independência entre eventos, probabilidade total e Teorema de Bayes, com foco na interpretação de evidências e atualização de probabilidades a partir de novas informações. Espera-se que os estudantes sejam capazes de calcular e interpretar probabilidades condicionais, avaliar se determinadas variáveis parecem associadas, compreender como uma informação observada altera a…
