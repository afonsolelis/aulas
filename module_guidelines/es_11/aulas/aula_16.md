# Aula 16 - GOVERNANÇA DE DADOS III

## Descrição da Aula
Esta instrução tem como objetivo aprofundar a compreensão dos alunos sobre aspectos estratégicos da Governança de Dados, com foco na gestão do ciclo de vida dos dados, na formulação de estratégias organizacionais orientadas a dados, na definição de KPIs relevantes para monitoramento de governança e na avaliação da maturidade em gestão de dados. A instrução busca preparar os alunos para pensar de forma sistêmica e estratégica sobre o papel dos dados como ativos corporativos, contribuindo para o alinhamento entre tecnologia, processos e objetivos de negócio.
...
**Eixo:** Computação
**Assuntos:** Frameworks de gestão: COBIT, ITIL
,Arquitetura TCP/IP
