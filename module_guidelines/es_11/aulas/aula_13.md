# Aula 13 - GOVERNANÇA DE DADOS I

## Descrição da Aula
Esta instrução tem como objetivo aprofundar os conhecimentos dos alunos sobre aspectos críticos da Governança de Dados relacionados à segurança, privacidade e classificação de dados, destacando a importância de proteger os ativos informacionais das organizações frente a riscos operacionais, legais e reputacionais. A aula discutirá práticas, políticas e mecanismos técnicos e organizacionais voltados à proteção e ao uso ético dos dados, capacitando os alunos a aplicar conceitos fundamentais de conformidade, controle de acesso e categorização de dados em ambientes reais.
...
**Eixo:** Computação
**Assuntos:** Gerenciamento de segurança
,Frameworks de gestão: COBIT, ITIL
**Sprint:** 2
