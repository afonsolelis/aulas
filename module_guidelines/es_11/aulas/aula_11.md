# Aula 11 - MODELAGEM DE WAREHOUSES III

## Descrição da Aula
Esta instrução tem como objetivo aprofundar os conhecimentos dos alunos em modelagem dimensional avançada, abordando técnicas específicas para lidar com complexidades comuns em projetos de Business Intelligence e Data Warehousing, como relacionamentos muitos-para-muitos, atributos de baixa cardinalidade e mudanças ao longo do tempo. O foco estará no uso de Bridge Tables, Junk Dimensions e Slowly Changing Dimensions (SCD), analisando como essas estratégias impactam a performance e a consistência analítica dos sistemas, além de demonstrar como implementá-las de forma prática em pipelines…
