# Aula 12 - GOVERNANÇA DE DADOS II

## Descrição da Aula
Esta instrução tem como objetivo introduzir os alunos aos fundamentos da Governança de Dados, destacando sua importância na gestão eficaz, segura e estratégica dos ativos informacionais de uma organização. Serão abordados os principais pilares da governança, como a definição de estruturas organizacionais e papéis, os critérios de qualidade dos dados, e a relevância dos metadados e catálogos para garantir rastreabilidade, confiabilidade e reuso. A aula prepara os alunos para compreender os desafios técnicos e organizacionais associados à governança e a adotar boas práticas em contextos…

---
**Visão RM-ODP:** Computational
**Eixo:** Computação
**Assuntos:** Modelos de arquitetura de sistemas distribuídos
