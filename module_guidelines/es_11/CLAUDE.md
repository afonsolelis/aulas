...
Educational curriculum repository for the discipline **"Arquitetura e Governança de Dados (ES11)"** at Inteli (Instituto de Tecnologia e Liderança). Course materials — lectures, self-study guides, sprint deliverable templates and assessment rubrics — no runnable code.

## Structure

- `aulas/` — 35 lecture modules (`aula_01.md` through `aula_35.md`) + a skill definition file
