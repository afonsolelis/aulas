# Autoestudo: Materialized views in ClickHouse®: The data transformation Swiss Army knife
 ...
 * Engines recomendadas;
 * Encadeamento de views;
 * Monitoramento e métricas;
 * Desafios com alta cardinalidade;
 * Limitações e alternativas;
 * Manutenção e cenários de uso;
