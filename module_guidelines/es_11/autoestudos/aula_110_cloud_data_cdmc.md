 ...
 * Avaliação prática & benchmarking;
 * Roadmap de adoção da nuvem;
 * Controle de riscos em nuvem;
 * Componentes do framework;
 * Estrutura de pontuação;
 * Benchmark e pesquisa de mercado;
 * Casos de adoção e certificações;
 * Histórico e governança do framework.
