# Autoestudo: Vídeo 2: Time Series Talk: Autoregressive Model (by Ritvikmath)
...
Assista ao vídeo "Time Series Talk: Autoregressive Model", produzido por Ritvikmath. Este vídeo apresenta uma introdução ao modelo AR em previsão de séries temporais.
