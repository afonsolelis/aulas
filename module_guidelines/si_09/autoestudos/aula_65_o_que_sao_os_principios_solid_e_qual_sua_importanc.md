# Autoestudo: O que são os princípios SOLID e qual sua importância para o design de aplicações
...
Este autoestudo oferece uma introdução sobre o que são os princípios SOLID além de detalhar a importância desses princípios no design das aplicações em ambientes organizacionais.
