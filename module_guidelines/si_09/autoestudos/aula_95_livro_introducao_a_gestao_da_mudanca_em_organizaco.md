# Autoestudo: Livro: introdução à gestão da mudança em organizações Capítulos 4
...
Este capítulo serve como um guia prático para a execução eficaz do processo de implementação de mudanças dentro de sua organização. Ele se divide em várias seções que abordam os elementos essenciais deste processo. Leitura das páginas 20 à 30

**Eixo disciplinar:** Negócios
**Assuntos:** Gestão da mudança
...
- https://www.livrosabertos.sibi.usp.br/portaldelivrosUSP/catalog/view/967/877/3228
