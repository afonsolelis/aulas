...
Educational curriculum repository for the discipline **"Dashboards Gerenciais (SI09)"** at Inteli (Instituto de Tecnologia e Liderança). Course materials — lectures, self-study guides, sprint deliverable templates and assessment rubrics — no runnable code.
