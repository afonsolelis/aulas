# Aula 10 - ARQUITETURA GERAL E ORIENTADA A SERVIÇOS (SOA) E A PERSPECTIVA DE REQUISITOS NÃO FUNCIONAIS

## Descrição da Aula
Nesta instrução você irá compreender o conceito geral de arquitetura de software, com destaque especial para a abordagem Orientada a Serviços (SOA). Este modelo é extremamente relevante no mercado atual, pois permite desenvolver sistemas escaláveis, flexíveis e facilmente integráveis, impactando positivamente a produtividade e agilidade das empresas.
Além disso, você conhecerá o conceito essencial de requisitos não funcionais, que estão diretamente relacionados à qualidade, desempenho e confiabilidade das aplicações. Entender esses requisitos é vital para garantir que o sistema não apenas…

---
**Visão RM-ODP:** Computational
**Eixo:** Computação
**Assuntos:** Engenharia de requisitos
,Arquitetura da Web
