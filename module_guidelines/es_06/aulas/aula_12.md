# Aula 12 - PADRÕES DE INTERAÇÃO E RECURSOS DE PERSONALIZAÇÃO

## Descrição da Aula
Neste encontro, vamos olhar para os padrões de interação mais usados em tecnologias atuais e como eles melhoram a experiência do usuário. Também veremos como adicionar opções de personalização para atender melhor a cada usuário. Através de exemplos práticos, também será possível entender o impacto real dessas estratégias e a importância da gamificação no envolvimento do usuário com a interface que será utilizada.
...
,Avaliação de IHC
,Design de interação
,Paradigmas e componentes de IHC
,Prototipação
,Usabilidade
**Sprint:** 2
