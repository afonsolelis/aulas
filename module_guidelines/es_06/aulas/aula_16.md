# Aula 16 - CENTRÓIDES E CLUSTERS: EXPLORANDO PADRÕES COM AGRUPAMENTO DE DADOS (ALGORITMO K-MEANS).

## Descrição da Aula
Centróides e Clusters: Explorando Padrões com Agrupamento de Dados (algoritmo k-means).
