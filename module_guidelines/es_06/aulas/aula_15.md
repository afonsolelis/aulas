# Aula 15 - TÓPICOS DE BD: STORED PROCEDURES E FUNCTIONS

## Descrição da Aula
Nesta instrução você irá aprofundar seus conhecimentos sobre Stored Procedures e Functions, elementos fundamentais para otimizar, simplificar e padronizar operações em bancos de dados relacionais, especialmente em aplicações empresariais.
Entender esses tópicos é essencial, pois Stored Procedures e Functions permitem executar operações complexas diretamente no servidor do banco, reduzindo tráfego na rede, aumentando o desempenho das consultas e facilitando a manutenção e segurança das aplicações no dia a dia do profissional de TI.
Durante a instrução você aprenderá a criar, gerenciar e…

---
**Visão RM-ODP:** Computational
**Eixo:** Computação
**Assuntos:** SQL Avançado
