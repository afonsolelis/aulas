...
Educational curriculum repository for the discipline **"Plataforma Digital Baseada em Arquitetura Orientada a Serviços (ES06)"** at Inteli (Instituto de Tecnologia e Liderança). Course materials — lectures, self-study guides, sprint deliverable templates and assessment rubrics — no runnable code.

## Structure

- `aulas/` — 30 lecture modules (`aula_01.md` through `aula_30.md`) + a skill definition file
