# Autoestudo: 2 Níveis de Testes | O que são Testes de Integração?
...
Este vídeo explica os diferentes níveis de testes de software, com foco nos testes de integração. Aborda a importância desses testes, como são realizados e sua relação com outros tipos de testes no ciclo de desenvolvimento de software.
...
- https://youtu.be/ewAwf02QVnQ?si=dqEJnUC3DwUUuc_-
