# Autoestudo: Gestão de processos (parte I)
...
Dê atenção especial a discussão sobre a relação entre processos e o desenvolvimento de sistemas de informação (A partir do minuto 07:30).

**Eixo disciplinar:** Negócios
**Assuntos:** Gestão de Processos de Negócio (BPM)
...
- https://www.youtube.com/watch?v=_rokM44E1ms
