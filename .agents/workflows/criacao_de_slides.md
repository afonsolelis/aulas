...
> [!NOTE] 
> Certifique-se de configurar as classes de CSS (`.slide-inner` etc) para ocuparem sempre full height sem impactar nas métricas originais que o projeto exigia.
